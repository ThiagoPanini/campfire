...
How AI assistants are integrated into the {PROJECT_NAME} project: categories of tooling, principles for adoption, and the active inventory.
...
{PROJECT_NAME} is built primarily through AI-assisted development. Treating AI as a first-class collaborator means treating its tooling as a first-class concern — what we use, why we use it, and when we adopt it.
