...
`campaign-chronicler` is a tool for D&D groups to log each player's per-session character actions and generate a chronicle-style lore document at the end of the campaign. Full vision: [../PRODUCT_VISION.md](../PRODUCT_VISION.md). MVP scope: [../docs/mvp-scope.md](../docs/mvp-scope.md).
