...
`flux` is a Pomodoro timer that logs what you worked on each focused session and produces a heatmap comparing where your time actually went versus where you thought it went. Full vision: [PRODUCT_VISION.md](./PRODUCT_VISION.md). MVP scope: [docs/mvp-scope.md](./docs/mvp-scope.md).
