...
from campfire_api.contexts.identity.adapters.http.schemas import AuthConfigResponse, GoogleConfig
...
async def auth_config(
    ...
    return AuthConfigResponse(google=GoogleConfig(enabled=await settings.google_enabled()))
