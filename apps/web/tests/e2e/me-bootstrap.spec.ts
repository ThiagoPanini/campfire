...
test("shows bootstrap screen content after protected entry", async ({ page }) => {
  ...
  await expect(page.getByText(/Campfire (profile was created|Welcome back to Campfire)/)).toBeVisible();
});
