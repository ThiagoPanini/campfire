...
User-facing UI strings are not covered by an ADR yet. The current landing page ships Portuguese copy (`<html lang="pt-BR">`, `entrar`, `criar conta`); treat this as an implementation fact and surface the open question before extending PT copy to new screens.
